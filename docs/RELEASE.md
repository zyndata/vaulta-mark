...
9. **Reconcile the listing copy with the package.** Open
   ...
   at any time and are worth a glance in the same sitting. Nothing is pending as of 1.2.0, which
   carried the English short description rewritten 2026-08-18 and the Polish one. The Polish
   listing's dashboard half — the detailed description — is pasted by hand under Language → Polish
